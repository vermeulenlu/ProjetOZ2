...
%%%% Players description %%%%
   ...
   NbBombers = 4
   Bombers = [player033AI player082advancedPlayer player082advancedPlayer player082advancedPlayer]
   ColorBombers = [red green c(255 128 192) blue]%%green = luigi, red = mario, blue = toad et c(255 128 192) = peach
